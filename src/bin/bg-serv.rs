...
use bevy_wallpaper::{
    DebugTexture, Mode, Shape, space_stuff::SpaceStuff, sphere::SphereMode, uv_debug_texture,
};
...
fn main() {
    ...
    App::new()
        ...
        // .add_systems(Startup, ())
        .add_systems(Startup, enter_sphere_mode)
        // .add_systems(
        //     Update,
        //     (
...
fn enter_sphere_mode(mut next_mode: ResMut<NextState<Mode>>) {
    next_mode.set(Mode::Sphere);
}
